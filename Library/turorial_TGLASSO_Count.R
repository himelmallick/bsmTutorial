...
load_github_data("https://github.com/himelmallick/bsmTutorial/blob/master/Data/TGLASSO_filtered.RData")
trainX = pcl$trainX
trainY1 = pcl$trainY
trainY = round(exp(trainY1))
...
save(fit.hs, file = paste(workingDirectory, './RdataOutput/fit.HSCount', '.RData', sep = ''))
save(fit.hsplus, file = paste(workingDirectory, './RdataOutput/fit.HSplusCount', '.RData', sep = ''))
save(fit.br, file = paste(workingDirectory, './RdataOutput/fit.BRCount', '.RData', sep = ''))
save(fit.bl, file = paste(workingDirectory, './RdataOutput/fit.BLCount', '.RData', sep = ''))
